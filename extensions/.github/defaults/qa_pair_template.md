...
- External tools used during answering: <web_search, osp-mcp.search_arxiv, osp-mcp.search_semantic_scholar, osp-mcp.search_medrxiv, osp-mcp.search_wos, osp-mcp.search_scopus, ...>
- Discrepancy count: <N>
