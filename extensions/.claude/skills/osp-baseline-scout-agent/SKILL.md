...
Use the same retrieval tools as the Literature Agent (`osp-mcp.search_arxiv`, `search_semantic_scholar`, `search_google_scholar`, `search_dblp`, `search_pubmed`, `search_biorxiv`, native Web Search). You are encouraged to run targeted searches like:
