...
4. **Available tools:** `osp-mcp.search_arxiv`, `search_semantic_scholar`, `search_google_scholar`, `search_dblp`, `search_pubmed`, `search_biorxiv`, native Web Search (where applicable).
