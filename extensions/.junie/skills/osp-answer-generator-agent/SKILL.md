...
4. **Available tools:** `osp-mcp.search_arxiv`, `search_semantic_scholar`, `search_google_scholar`, `search_dblp`, `search_pubmed`, `search_biorxiv`, `search_medrxiv`, `search_wos`, `search_scopus`, `search_sciencedirect`, `search_ieee_xplore`, `search_acm`, `search_springer`, native Web Search (where applicable).
